import{_ as a,r as t,o as p,c as o,a as n,b as c,d as e,e as l}from"./app-01lAtpvS.js";const u={},i=l(`<blockquote><p>JavaScript声明过的变量提升往往会影响到我们对变量的正常获取，所以特写此文，以便以后翻阅。</p></blockquote><h2 id="什么是变量提升" tabindex="-1"><a class="header-anchor" href="#什么是变量提升"><span>什么是变量提升</span></a></h2><pre><code class="language-javascript"><span class="token comment">//变量声明提升</span>
...
<span class="token punctuation">}</span>
</code></pre><blockquote><p>js中定义变量有两种情况：（注意在方法外不加var是不能定义变量的，出现xx is not defined）</p><ol><li>都加var，在方法内则是局部变量，在方法外则是全局变量。</li><li>在方法内,加var为局部变量，不加var则是全局变量（在执行当前方法之后）</li></ol></blockquote><h2 id="变量提升案例" tabindex="-1"><a class="header-anchor" href="#变量提升案例"><span>变量提升案例</span></a></h2><h3 id="案例1" tabindex="-1"><a class="header-anchor" href="#案例1"><span>案例1</span></a></h3><p>由于test1函数里面定义了变量a，由于</p><pre><code class="language-javascript"><span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token string">&#39;I\\&#39;m a in all&#39;</span>
...
</code></pre><p>上述代码相当于</p><pre><code class="language-javascript"><span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token string">&#39;I\\&#39;m a in all&#39;</span>
...
<span class="token function">test1</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><h3 id="案例2" tabindex="-1"><a class="header-anchor" href="#案例2"><span>案例2</span></a></h3><pre><code class="language-javascript"><span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token string">&#39;I\\&#39;m a in all&#39;</span>
...
</code></pre><h3 id="案例3" tabindex="-1"><a class="header-anchor" href="#案例3"><span>案例3</span></a></h3><pre><code class="language-javascript"><span class="token keyword">function</span> <span class="token function">test3_1</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>a<span class="token punctuation">)</span> <span class="token comment">// 不输出</span>
</code></pre><pre><code class="language-javascript"><span class="token keyword">function</span> <span class="token function">test3_2</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre>`,15),k={href:"http://recoluan.gitlab.io",target:"_blank",rel:"noopener noreferrer"},r=n("strong",null,"午后南杂",-1);function d(f,m){const s=t("ExternalLinkIcon");return p(),o("div",null,[i,n("p",null,[c("个人博客："),n("a",k,[r,e(s)])])])}const h=a(u,[["render",d],["__file","020401.html.vue"]]),v=JSON.parse('{"path":"/blogs/frontEnd/2018/020401.html","title":"js变量提升以及var对变量提升的影响","lang":"zh-CN","frontmatter":{"title":"js变量提升以及var对变量提升的影响","date":"2018-02-04T00:00:00.000Z","tags":["javascript"],"categories":["frontEnd"]},"headers":[{"level":2,"title":"什么是变量提升","slug":"什么是变量提升","link":"#什么是变量提升","children":[]},{"level":2,"title":"变量提升案例","slug":"变量提升案例","link":"#变量提升案例","children":[{"level":3,"title":"案例1","slug":"案例1","link":"#案例1","children":[]},{"level":3,"title":"案例2","slug":"案例2","link":"#案例2","children":[]},{"level":3,"title":"案例3","slug":"案例3","link":"#案例3","children":[]}]}],"git":{"createdTime":1716921053000,"updatedTime":1716921053000,"contributors":[{"name":"Reco","email":"recoluan@qq.com","commits":1}]},"filePathRelative":"blogs/frontEnd/2018/020401.md"}');export{h as comp,v as data};
