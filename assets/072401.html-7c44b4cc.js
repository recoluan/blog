...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,46);function h(f,x){const e=t("ExternalLinkIcon");return o(),c("div",null,[u,l(" more "),d,k,v,n("p",null,[s("如果报错 "),m,s("，可以借助 "),n("a",b,[s("eslint-plugin-html"),i(e)]),s("来解决。")]),g,y])}const j=p(r,[["render",h],["__file","072401.html.vue"]]);export{j as default};
