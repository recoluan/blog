import{_ as t,r as o,o as e,c,a as s,b as n,d as l,e as a}from"./app-01lAtpvS.js";const r={},u=a(`<h2 id="webpack简介" tabindex="-1"><a class="header-anchor" href="#webpack简介"><span>webpack简介</span></a></h2><p>webpack是一个 <strong>模块打包工具</strong>，支持所有的打包语法，比如 <code>ES Module</code>、<code>CommonJS</code>、<code>CMD</code>、<code>AMD</code>。初期的webpack是用来模块打包js的，发展到现在，已经可以打包很多种文件类型，比如 <code>css</code>、<code>img</code> 。</p><p>优化打包速度最有效的方法就是保持 <code>nodejs</code> 和 <code>webpack</code> 为最新版本。</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><p>安装 <code>webpack</code> 建议根据项目安装而不是全局安装，可以使用以下命令：</p><pre><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> webpack webpack-cli --save-dev
...
</code></pre><p>这个时候执行 <code>webpack -v</code> 是查不到版本号的，因为 <code>nodejs</code> 默认是去全局找 <code>webpack</code>，这个时候是找不到的，nodejs还提供了 <code>npx webpack -v</code> 这个方法。</p><h2 id="运行" tabindex="-1"><a class="header-anchor" href="#运行"><span>运行</span></a></h2><p>如果不生成配置文件，webpack会按照默认配置去打包，如果我们想自定义配置文件可以在项目根目录添加 <code>webpack.config.js</code> 来自定义配置信息，配置文件的名字也可以自定义：</p><pre><code class="language-bash"><span class="token comment"># 默认配置或者默认配置文件</span>
npx webpack
...
</code></pre><p>一个简单的配置：</p><pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><p>其中 <code>entry</code> 可以写成这样：</p><pre><code class="language-js"><span class="token literal-property property">entry</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><p>其实，开始安装的 <code>webpack-cli</code> 就是为了在命令行工具中可以正确地执行命令行工具。</p><h2 id="loader" tabindex="-1"><a class="header-anchor" href="#loader"><span>loader</span></a></h2><p><code>webpack</code> 可以使用 <code>loader</code> 来预处理文件。这允许你打包除 <code>JavaScript</code> 之外的任何静态资源，js的打包是webpack内置的。你可以使用 <code>Node.js</code> 来很简单地编写自己的 <code>loader</code>。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="file-loader" tabindex="-1"><a class="header-anchor" href="#file-loader"><span>file-loader</span></a></h3><p>处理文件模块的 webpack loader。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="url-loader" tabindex="-1"><a class="header-anchor" href="#url-loader"><span>url-loader</span></a></h3><p><code>file-loader</code> 的增强版，除了上述功能，还可以将文件转换为 <code>base64 URI</code>。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="css相关" tabindex="-1"><a class="header-anchor" href="#css相关"><span>css相关</span></a></h3><h4 id="style-loader-和-css-loader" tabindex="-1"><a class="header-anchor" href="#style-loader-和-css-loader"><span>style-loader 和 css-loader</span></a></h4><ul><li>css-loader：加入 a.css 中引入了 b.css 和 c.css，css-loader 会将其合并成一个css文件</li><li>style-loader：将合并后的 css 文件挂载到 head 标签内</li></ul><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h4 id="sass-loader" tabindex="-1"><a class="header-anchor" href="#sass-loader"><span>sass-loader</span></a></h4><p>如果使用 scss、less、stylus 等 css 预处理器。例如，我们要使用 sass 预处理器，首先要安装 sass-loader 和 node-sass。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="custom-container warning"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"></circle><path d="M12 8v4"></path><path d="M12 16h.01"></path></g></svg><p class="custom-container-title">WARNING</p><p>loader的加载顺序是从右到左、从下到上，所以处理 scss 文件时，将 sass-loader放在最后。</p></div><h4 id="postcss-loader" tabindex="-1"><a class="header-anchor" href="#postcss-loader"><span>postcss-loader</span></a></h4><p>通过 postcss-loader 来给新属性添加厂商前缀。</p><pre><code class="language-js"><span class="token comment">// webpack.config.js</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><pre><code class="language-js"><span class="token comment">// postcss.config.js</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><p>如果 a.css 中引入了 b.css 和 c.css，当读到 <code>@import(&#39;./b.css&#39;)</code> 时就会略过 postcss-loader 和 sass-loader，直接从 css-loader 直接运行，可以通过 <code>importLoaders</code> 配置来改善。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h4 id="css模块化" tabindex="-1"><a class="header-anchor" href="#css模块化"><span>css模块化</span></a></h4><p>在 <code>index.js</code> 通过import <code>&#39;./index.css&#39;</code> 引入样式会全局有效，如果想在某个模块有效，如何去做呢？</p><pre><code class="language-js"><span class="token comment">// 模块A</span>
...
</code></pre><pre><code class="language-js"><span class="token comment">// webpack.config.js</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h4 id="字体" tabindex="-1"><a class="header-anchor" href="#字体"><span>字体</span></a></h4><p>字体文件只需要通过 file-loader 将字体文件转移到打包文件夹内即可。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="plugin" tabindex="-1"><a class="header-anchor" href="#plugin"><span>plugin</span></a></h2><p>可以在webpack运行到某个时刻的时候，做一些事情。</p><h3 id="html-webpack-plugin" tabindex="-1"><a class="header-anchor" href="#html-webpack-plugin"><span>html-webpack-plugin</span></a></h3><p>会在打包之后，自动生成一个 html 文件，并把打包生成的 js 自动引入到这个 html 文件中。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span>
</code></pre><p>但是我们可能需要在 index.html 中写一些默认代码，比如 meta，这时就可以按照某个模板来生成这个 index.html。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> HtmlWebpackPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;html-webpack-plugin&#39;</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span>
</code></pre><h3 id="clean-webpack-plugin" tabindex="-1"><a class="header-anchor" href="#clean-webpack-plugin"><span>clean-webpack-plugin</span></a></h3><p>会在打包前先清空打包目标文件夹的文件。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> HtmlWebpackPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;html-webpack-plugin&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="多个输出文件" tabindex="-1"><a class="header-anchor" href="#多个输出文件"><span>多个输出文件</span></a></h2><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> HtmlWebpackPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;html-webpack-plugin&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> CleanWebpackPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;clean-webpack-plugin&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p>如果我们的打包后的文件中，index.html 需要给后台做配置文件，assets 文件夹需要放在 cdn 上，这样的话我们的就需要在 output 中设置 publicPath：</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> HtmlWebpackPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;html-webpack-plugin&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> CleanWebpackPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;clean-webpack-plugin&#39;</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="webpack-dev-server" tabindex="-1"><a class="header-anchor" href="#webpack-dev-server"><span>webpack-dev-server</span></a></h3><p>上面的html的打开的方式还是需要通过 <code>file</code> 协议打开一个本地文件，在浏览器地址是这样的：<code>file:///Users/reco/workSpace/git/personal/work/test.html</code>。这样的话发送 <code>AJAX</code> 请求就有问题了，因为发送请求需要 <code>http</code> 或者 <code>https</code> 协议，这时需要的是在本地启动一个服务，我们可以借助 <code>webpack-dev-server</code> （打包时将打包的文件放在内存中，提高打包速度）。</p><pre><code class="language-bash"><span class="token function">yarn</span> <span class="token function">add</span> webpack-dev-server <span class="token parameter variable">--dev</span>
</code></pre><pre><code class="language-json"><span class="token punctuation">{</span>
  <span class="token property">&quot;scripts&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">&quot;build&quot;</span><span class="token operator">:</span> <span class="token string">&quot;webpack&quot;</span><span class="token punctuation">,</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p><strong>自己写一个简单的 webpack-dev-server</strong></p><pre><code class="language-json"><span class="token punctuation">{</span>
  <span class="token property">&quot;scripts&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">&quot;server&quot;</span><span class="token operator">:</span> <span class="token string">&quot;node server.js&quot;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><pre><code class="language-js"><span class="token comment">// server.js</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><blockquote><p>**缺点：**需要自己手动刷新</p></blockquote><p>上面这种方式就是在node中使用webpack，这是除了在命令行中的使用 <code>webpack</code> 的另一种方式。</p><p><strong>开启 Hot Module Replacement</strong></p><p>解决下面的问题：</p><ol><li>修改页面某个颜色，页面会刷新，导致动态添加的 dom 会消失；</li><li>一个页面同时引入两个模块的js，修改某个模块的js，页面会刷新，导致灵感一个模块的js也会初始化。</li></ol><p>存在的问题：</p><ol><li>在多页面应用里，html更改时并不会刷新，需手动，所以这种情况下，可以去掉更更新功能。</li></ol><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><p>案例：</p><pre><code class="language-js"><span class="token keyword">import</span> counter <span class="token keyword">from</span> <span class="token string">&#39;./counter&#39;</span>
...
<span class="token keyword">if</span> <span class="token punctuation">(</span>module<span class="token punctuation">.</span>hot<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><p>当引用 css 的时候只需要引用，并不需要上面这一坨代码，就是因为 <code>css-loader</code> 已经内置了上面的方法，就像在写 vue、react 代码不需要写上面这坨代码一样，他们的 loader 中也内置了这些方法。只有在使用一些特殊的文件类型才需要。（react 是借助 babel-preset 实现的）</p><blockquote><p>业务开发时，一般不是设置 hotOnly 这样才能试试显示最新代码和更改效果</p></blockquote><h2 id="babel" tabindex="-1"><a class="header-anchor" href="#babel"><span>Babel</span></a></h2><h3 id="安装-1" tabindex="-1"><a class="header-anchor" href="#安装-1"><span>安装</span></a></h3><pre><code class="language-bash"><span class="token comment"># babel-loader将 webpack 与 babel 建立关联</span>
...
<span class="token function">npm</span> <span class="token function">install</span> --save-dev babel-loader @babel/core
</code></pre><pre><code class="language-js"><span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">rules</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token punctuation">{</span> 
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="语法转换" tabindex="-1"><a class="header-anchor" href="#语法转换"><span>语法转换</span></a></h3><p>这个时候还是不可以转换，还需要这样</p><pre><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> @babel/preset-env --save-dev
</code></pre><p>然后配置 options</p><pre><code class="language-js"><span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">rules</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token punctuation">{</span> 
      <span class="token literal-property property">test</span><span class="token operator">:</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">\\.js$</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">,</span> 
      <span class="token literal-property property">exclude</span><span class="token operator">:</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">node_modules</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">,</span> 
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="变量、对象转换" tabindex="-1"><a class="header-anchor" href="#变量、对象转换"><span>变量、对象转换</span></a></h3><p>这个时候也只能对一些语法进行转换，比如 “箭头函数”，如果想要对 <code>Promise</code> 这些新的对象进行转换（准确来说，浏览器可能不支持新规范的的一些对象，所以需要单独封装这些方法，然后在全局注入），还需要这样：</p><pre><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">--save</span> @babel/polyfill
</code></pre><pre><code class="language-js"><span class="token comment">// 在入口文件</span>
...
<span class="token keyword">import</span> <span class="token string">&quot;@babel/polyfill&quot;</span><span class="token punctuation">;</span>
</code></pre><p>这个时候会默认全部转换，这样会增加很多兼容性代码，如果我们想按需引入：</p><pre><code class="language-js"><span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">rules</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    <span class="token punctuation">{</span> 
      <span class="token literal-property property">test</span><span class="token operator">:</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">\\.js$</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">,</span> 
      <span class="token literal-property property">exclude</span><span class="token operator">:</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">node_modules</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">,</span> 
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><p>有的同学问：<code>babel-polyfill</code> 这样引用可不可以？答案是可以，但是在使用 <code>useBuiltIns: &#39;usage&#39;</code> 时就不可以了。</p><pre><code class="language-js"><span class="token comment">// 在入口配置</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><p><code>@babel/preset-env</code> 还可以拥有其他配置参数，比如：</p><pre><code class="language-json"><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">]</span><span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><p>上面配置的意思是，只需要兼容 chrome 浏览器 67 版本以上就可以了，这样转译时会根据浏览器的兼容性来合理处理转译结果。</p><h3 id="组件库的封装" tabindex="-1"><a class="header-anchor" href="#组件库的封装"><span>组件库的封装</span></a></h3><p>如果只是开发业务代码，使用上面 <code>presets</code> + <code>babel-polyfill</code> 的方式就可以了，但是 <code>babel-polyfill</code> 有一个确定就是会将变量全局注入，这里可以使用 <code>transform-runtime</code> 来以闭包（或其他）的形式来进行引入，避免全局环境的污染。</p><pre><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> --save-dev @babel/plugin-transform-runtime
...
<span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">--save</span> @babel/runtime
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><p>将 <code>corejs</code> 的值设置为 2，才会将 <code>map</code> 、<code>promise</code>等方法打包到 <code>main.js</code>，当然还需要引入另一个依赖：</p><pre><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">--save</span> @babel/runtime-corejs2
</code></pre><h3 id="babelrc" tabindex="-1"><a class="header-anchor" href="#babelrc"><span><code>.babelrc</code></span></a></h3><p>如果 babel 的配置过于复杂，内容较多，可以将其单独放在 <code>.babelrc</code> 文件内：</p><pre><code class="language-json"><span class="token punctuation">{</span>
  <span class="token property">&quot;presets&quot;</span><span class="token operator">:</span> <span class="token punctuation">[</span><span class="token punctuation">[</span><span class="token string">&quot;@babel/preset-env&quot;</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
    useBuiltIns<span class="token operator">:</span> &#39;usage&#39;
  <span class="token punctuation">}</span><span class="token punctuation">]</span><span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="react打包" tabindex="-1"><a class="header-anchor" href="#react打包"><span>React打包</span></a></h2><pre><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> --save-dev @babel/preset-react
</code></pre><pre><code class="language-json"><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="tree-shaking" tabindex="-1"><a class="header-anchor" href="#tree-shaking"><span>Tree Shaking</span></a></h2><blockquote><p>只支持 ES Module，因为 ES Module 是静态引入</p></blockquote><p>作用：模块按需引入，不会将全部代码引用过来</p><h3 id="development" tabindex="-1"><a class="header-anchor" href="#development"><span>development</span></a></h3><p><strong>webpack.config.js</strong></p><pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p><code>usedExports</code> 意思就是检查一下哪些模块被使用了再做打包。</p><p><strong>package.json</strong></p><pre><code class="language-json"><span class="token punctuation">{</span>
  <span class="token property">&quot;sideEffects&quot;</span><span class="token operator">:</span> <span class="token boolean">false</span>
<span class="token punctuation">}</span>
</code></pre><p>如果引入的一些 <code>css</code> 或依赖不需要 <code>Tree Shaking</code>，那将 <code>sideEffects</code> 设置为 <code>[&quot;./a.css&quot;, &quot;@babel/polyfill&quot;]</code>，如果没有需要配置的，直接设置为 <code>false</code> 即可。</p><h3 id="production" tabindex="-1"><a class="header-anchor" href="#production"><span>production</span></a></h3><p>线上环境是不需要配置 <code>usedExports</code> 的，但是还是需要配置 <code>package.json</code>。</p><h2 id="配置文件整理" tabindex="-1"><a class="header-anchor" href="#配置文件整理"><span>配置文件整理</span></a></h2><p>比如在 <code>Vue</code> 官方的脚手架中 <code>webpack</code> 的配置文件都放在 <code>build</code> 文件夹中，如果我们希望对配置文件进行整理的话，需要做一下处理：</p><ol><li><p>将开发环境和线上环境的公共配置提取到 <code>/build/webpack.base.js</code> 中</p></li><li><p>分别在开发环境和线上环境的配置中合并公共配置，配置合并需要使用 <code>webpack-merge</code></p><pre><code class="language-js"><span class="token comment">// /build/webpack.dev.js</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token function">merge</span><span class="token punctuation">(</span>baseConfig<span class="token punctuation">,</span> devConfig<span class="token punctuation">)</span>
</code></pre></li><li><p>修改 <code>package.json</code></p><pre><code class="language-json"><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></li><li><p>这个时候较之前打包输出和清空的目录就应该修改一下了</p><pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">output</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">filename</span><span class="token operator">:</span> <span class="token string">&#39;bundle.js&#39;</span><span class="token punctuation">,</span>
    <span class="token literal-property property">path</span><span class="token operator">:</span> path<span class="token punctuation">.</span><span class="token function">resolve</span><span class="token punctuation">(</span>__dirname<span class="token punctuation">,</span> <span class="token string">&#39;../dist&#39;</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><p><strong>更新</strong>：上面 <code>CleanWebpackPlugin</code> 的语法是 <code>1.0</code> 版本的。<code>2.0</code> 它所清空的文件夹默认就是打包输出目录，无需再单独指定。</p></li></ol><h2 id="code-splitting" tabindex="-1"><a class="header-anchor" href="#code-splitting"><span>Code Splitting</span></a></h2><h3 id="原理" tabindex="-1"><a class="header-anchor" href="#原理"><span>原理</span></a></h3><p>代码拆分——通过对公用代码的拆分来提升性能。</p><p>本来代码拆分和 <code>webpack</code> 是没关系的，只不过是一种优化手段，比如将公共代码单独打包到一个文件内，业务代码打包到另一个文件内，从而提升加载体验。这里可以运用多入口文件的方式分开打包。</p><h3 id="webpack实现" tabindex="-1"><a class="header-anchor" href="#webpack实现"><span>webpack实现</span></a></h3><p><code>webpack4.0</code> 实现代码分割，分两种情况：</p><ol><li>同步代码需要配置 <code>splitChunks</code></li></ol><pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">optimization</span><span class="token operator">:</span> <span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><ol start="2"><li>异步代码不需要做任何操作，异步代码比如下面这种情况：</li></ol><pre><code class="language-js"><span class="token keyword">function</span> <span class="token function">createElement</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><blockquote><p>这个写法会报错，因为动态来获取依赖的这种方式是试验性语法，目前还不支持，需要借助插件：<code>babel-plugin-dynamic-import-webpack</code></p></blockquote><hr><h3 id="splitchunksplugin" tabindex="-1"><a class="header-anchor" href="#splitchunksplugin"><span>SplitChunksPlugin</span></a></h3><p><strong>魔法注释</strong></p><pre><code class="language-js"><span class="token keyword">function</span> <span class="token function">createElement</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token function">createElement</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span><span class="token parameter">element</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  documnet<span class="token punctuation">.</span>body<span class="token punctuation">.</span><span class="token function">append</span><span class="token punctuation">(</span>element<span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><p><code>babel-plugin-dynamic-import-webpack</code> 不支持魔法注释，所以要换成 <code>@babel/plugin-syntax-dynamic-import</code>，这个时候会打包生成 <code>vendors~lodash.js</code>，如果需要修改打包后的名字，可以设置 <code>optimization</code>：</p><pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="lazy-loading-chunk" tabindex="-1"><a class="header-anchor" href="#lazy-loading-chunk"><span>Lazy Loading &amp; Chunk</span></a></h2><h3 id="lazy-loading" tabindex="-1"><a class="header-anchor" href="#lazy-loading"><span>Lazy Loading</span></a></h3><p><code>webpack</code> 可以识别 <code>ECMAScript</code> 的import返回的promise，并进行分割，实现懒加载，但是必须依赖 <code>babel-polyfill</code> 或者 <code>promise-polyfill</code>。</p><pre><code class="language-js"><span class="token keyword">function</span> <span class="token function">createElement</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">import</span><span class="token punctuation">(</span><span class="token comment">/* webpackChunkName: &#39;loadsh&#39; */</span><span class="token punctuation">,</span> <span class="token string">&#39;lodash&#39;</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">then</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter"><span class="token punctuation">{</span> <span class="token keyword">default</span><span class="token operator">:</span> _ <span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
    <span class="token keyword">const</span> element <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">createElement</span><span class="token punctuation">(</span><span class="token string">&#39;div&#39;</span><span class="token punctuation">)</span>
    div<span class="token punctuation">.</span>innerHTML <span class="token operator">=</span> _<span class="token punctuation">.</span><span class="token function">join</span><span class="token punctuation">(</span><span class="token punctuation">[</span><span class="token string">&#39;a&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;b&#39;</span><span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token string">&#39;-&#39;</span><span class="token punctuation">)</span>
    <span class="token keyword">return</span> element
...
document<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">&#39;click&#39;</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><p>用 <code>ES7</code> 的 <code>async</code> 和 <code>await</code> 函数重构一下：</p><pre><code class="language-js"><span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token function">createElement</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
document<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">&#39;click&#39;</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><h3 id="chunk" tabindex="-1"><a class="header-anchor" href="#chunk"><span>Chunk</span></a></h3><p>像上面的 <code>Lazy Loading</code> 所拆分打包的每一个文件都是一个 <code>Chunk</code>，而前面的配置参数<code> minChunks: 2</code> 的意思就是：当有2个以上的 · 使用到某个依赖时，才会对其进行拆分成一个 <code>Chunk</code>。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="打包分析" tabindex="-1"><a class="header-anchor" href="#打包分析"><span>打包分析</span></a></h2><p><code>http://webpack.js.org/guides/code-splitting/#bundle-analysis</code>，这是官网对打包分析的几个总结，其中最好用的是 <code>webpack-bundle-analyzer</code>。</p><p><strong>webpack 希望我们怎么样写代码呢？</strong></p><pre><code class="language-js"><span class="token comment">// 原来我们是这么写代码的</span>
document<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">&#39;click&#39;</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  <span class="token keyword">const</span> element <span class="token operator">=</span> document<span class="token punctuation">.</span><span class="token function">createElement</span><span class="token punctuation">(</span><span class="token string">&#39;div&#39;</span><span class="token punctuation">)</span>
  element<span class="token punctuation">.</span>innerHTML <span class="token operator">=</span> <span class="token number">123</span>
  documnet<span class="token punctuation">.</span>body<span class="token punctuation">.</span><span class="token function">append</span><span class="token punctuation">(</span>element<span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><p>上面的代码的加载利用率是较低的，因为创建元素实在点击事件触发后才触发的，所以可以分离出去：</p><pre><code class="language-js"><span class="token comment">// 现在我们可以这么写</span>
...
document<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">&#39;click&#39;</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><p>所以我们现在写代码应该考虑的不是缓存的问题，而是代码的利用率。所以在 <code>chunks</code> 默认设置为 <code>async</code> 而不是 <code>all</code>，是因为，同步的代码只能增加缓存，而对性能提升非常有限。</p><blockquote><p>谷歌浏览器查看网页的利用率：控制台 --&gt; ctrl+shift+p --&gt; coverage</p></blockquote><hr><p>比如点击登录的时候会出现一个模态框，首页的加载并不需要加载模态框的，但是点击登录按钮再加载，模态框的加载是会变慢的，这就需要下面的两个方法了：<code>Preloading</code> 和 <code>Prefetching</code>。</p><h3 id="prefetching" tabindex="-1"><a class="header-anchor" href="#prefetching"><span>Prefetching</span></a></h3><p><strong>非主要业务模块会在主要业务模块加载完之后，空闲时间再去加载。</strong></p><pre><code class="language-js"><span class="token comment">// 现在我们可以这么写</span>
...
document<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">&#39;click&#39;</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><h3 id="preloading" tabindex="-1"><a class="header-anchor" href="#preloading"><span>Preloading</span></a></h3><p><strong>而这个模式下，非主要业务模块会和主要业务模块一起加载</strong></p><pre><code class="language-js"><span class="token comment">// 现在我们可以这么写</span>
...
document<span class="token punctuation">.</span><span class="token function">addEventListener</span><span class="token punctuation">(</span><span class="token string">&#39;click&#39;</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><h3 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h3><p>目前考虑前端的性能优化，不能总是考虑缓存，而是主要考虑代码的使用率。</p><h2 id="css代码分割" tabindex="-1"><a class="header-anchor" href="#css代码分割"><span>CSS代码分割</span></a></h2><h3 id="css分割" tabindex="-1"><a class="header-anchor" href="#css分割"><span>CSS分割</span></a></h3><p>不做处理的情况下，<code>webpack</code> 会将 <code>css</code> 打包到 <code>js</code> 中去，如果需要生成单独的 <code>css</code> 文件，可以使用 <code>MiniCssExtractPlugin</code>。</p><pre><code class="language-bash"><span class="token comment"># 安装</span>
<span class="token function">npm</span> <span class="token function">install</span> --save-dev mini-css-extract-plugin
</code></pre><p>配置步骤：</p><ol><li>配置 <code>plugins</code>；</li><li>将 <code>style-loader</code> 改为 <code>MiniCssExtractPlugin.loader</code>；</li><li>如果设置了 <code>Tree Shaking</code>，需要将 <code>&quot;sideEffects&quot;: false</code> 改为 <code>&quot;sideEffects&quot;: [&quot;*.css&quot;]</code>。</li></ol><pre><code class="language-js"><span class="token keyword">const</span> MiniCssExtractPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;mini-css-extract-plugin&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span> 
...
<span class="token punctuation">}</span>
</code></pre><h3 id="css-压缩" tabindex="-1"><a class="header-anchor" href="#css-压缩"><span>CSS 压缩</span></a></h3><p><code>optimize-css-assets-webpack-plugin</code></p><pre><code class="language-js"><span class="token keyword">const</span> OptimizeCSSAssetsPlugin <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;optimize-css-assets-webpack-plugin&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><h3 id="合并-css" tabindex="-1"><a class="header-anchor" href="#合并-css"><span>合并 CSS</span></a></h3><p>将多个入口文件的 <code>css</code> 单独放到每个文件中，需要设置 <code>optimization.splitChunks.cacheGroups</code> 为对应的多个分组。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><h2 id="浏览器缓存" tabindex="-1"><a class="header-anchor" href="#浏览器缓存"><span>浏览器缓存</span></a></h2><p><code>contenthash</code> 如果内容没有变化，hash值不会变；如果内容变化，hash就会变。这样项目重新打包上线后，项目就不会全部重新加载了。</p><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p>如果 <code>webpack</code> 是老版本，还需要配置一下 <code>runtimeChunk</code>：</p><pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">optimization</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p>这是因为：代码有没有变化的逻辑关系被打包到一个叫 <code>manifest</code> 的东西来里，旧版本的 <code>webpack</code> 是会将这个东西直接打包到每个 <code>chunk</code> 文件中，而所以导致每次打包都不一致，这样的话配置好 <code>runtimeChunk</code>之后，所有的<code>manifest</code> 都会提取到名为 <code>runtime</code> 的文件内，所以就不会影响打包了。</p><h2 id="shimming-垫片" tabindex="-1"><a class="header-anchor" href="#shimming-垫片"><span>Shimming (垫片)</span></a></h2><p><code>babel-polyfill</code> 就是一个全局垫片，<code>babel-plugin-transform-runtime</code> 是一个局部垫片。下面介绍几种垫片：</p><ol><li><p>如果我们在 <code>a.js</code> 引用了一个 <code>utils.js</code> 的里面的方法，而这个方法需要借助 <code>jquery</code>， <code>a.js</code> 引用了<code>jquery</code>，而 <code>utils.js</code> 没有，这时候是会报错的，所以可以借助 <code>webpack.ProvidePlugin</code> 全局 在使用 $ 的地方引用 <code>jquery</code>。</p></li><li><p><code>webpack.ProvidePlugin</code> 还有另外一个功能：如果我们想要将 <code>$.each</code> 功能直接这样使用 <code>$each</code>，我们在下面这么来配置。</p><pre><code class="language-js"><span class="token keyword">import</span> webpack <span class="token keyword">from</span> <span class="token string">&#39;webpack&#39;</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre></li><li><p>每个模块的 <code>this</code> 都是指向当前模块的，如果想让每个模块都指向 <code>window</code>，我们需要借助 <code>imports-loader</code>：</p><pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">rules</span><span class="token operator">:</span> <span class="token punctuation">[</span>
      <span class="token punctuation">{</span>
        <span class="token literal-property property">test</span><span class="token operator">:</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">\\.js$</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">,</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></li></ol><h2 id="环境变量" tabindex="-1"><a class="header-anchor" href="#环境变量"><span>环境变量</span></a></h2><pre><code class="language-js"><span class="token comment">// webpack.common.js</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="区分模式打包" tabindex="-1"><a class="header-anchor" href="#区分模式打包"><span>区分模式打包</span></a></h2><p>区别：</p><ol><li>develop 模式下的sourceMap 是非常全的；</li><li>develop 模式下的代码不需要压缩；</li></ol><h2 id="函数库打包" tabindex="-1"><a class="header-anchor" href="#函数库打包"><span>函数库打包</span></a></h2><h3 id="指定代码运行范围" tabindex="-1"><a class="header-anchor" href="#指定代码运行范围"><span>指定代码运行范围</span></a></h3><pre><code class="language-js"><span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span> 
</code></pre><p>比如我的这个函数库依赖 <code>jquery</code>，但是用户也可能引用了 <code>jquery</code>，这样就会多打包一份，所以为了减少代码量，这时就可以通过 <code>externals</code> 来忽略 <code>jquery</code>（<code>externals</code> 支持 <code>Arrary/Object</code>）。</p><h2 id="progressive-web-application" tabindex="-1"><a class="header-anchor" href="#progressive-web-application"><span>Progressive Web Application</span></a></h2><p>第一次访问成功，第二次访问时如果服务挂掉了，这个时候让项目走缓存，而不是显示服务错误页面。</p><p><code>PWA</code> 的技术原理是 <code>server work</code>，这里可以借助 <code>workbox-webpack-plugin</code>：</p><pre><code class="language-js"><span class="token comment">// webpack.config.js</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><p>打包之后就产生两个文件：<code>service-work.js</code> 和 <code>precache-manifest.js</code>，下面还需要在入口文件写一下相关配置：</p><pre><code class="language-js"><span class="token comment">// index.js</span>
...
<span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token string">&#39;serviceWorker&#39;</span> <span class="token keyword">in</span> navigator<span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><h2 id="typescript-的打包配置" tabindex="-1"><a class="header-anchor" href="#typescript-的打包配置"><span>TypeScript 的打包配置</span></a></h2><pre><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> ts-loader <span class="token parameter variable">-D</span>
</code></pre><pre><code class="language-js"><span class="token comment">// webpack.config.js</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">mode</span><span class="token operator">:</span> <span class="token string">&#39;production&#39;</span><span class="token punctuation">,</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p>还需要创建 <code>tsconfig.json</code>：</p><pre><code class="language-json"><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p>如果我们引入了 <code>jquery</code> 这个模块，要想在使用 <code>jquery</code> 语法时让typescript有效，还需要引入 <code>@types/jquery</code> 这个依赖（这是 2.0 的做法，1.0 稍有区别），不然会报错：<code>TS2688: Cannot find type definition file for &#39;unist&#39;.</code>。</p><h2 id="webpackdevserver-请求转发" tabindex="-1"><a class="header-anchor" href="#webpackdevserver-请求转发"><span>WebpackDevServer 请求转发</span></a></h2><h3 id="proxy" tabindex="-1"><a class="header-anchor" href="#proxy"><span>proxy</span></a></h3><p><code>WebpackDevServer</code> 的 <code>proxy</code> 是可以直接配置代理的：</p><pre><code class="language-js"><span class="token comment">// webpack.config.js</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">devServer</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">proxy</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="historyapifallback" tabindex="-1"><a class="header-anchor" href="#historyapifallback"><span>historyApiFallback</span></a></h3><pre><code class="language-js"><span class="token comment">// webpack.config.js</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span> 
  <span class="token literal-property property">devServer</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p>如果一个项目里在写单页面应用时，某个路由我们没有配置某个路由 A，访问时会显示 <code>can&#39;t get A</code>，这是我们可以配置 <code>historyApiFallback: true</code> 来将没有配置的页面直接转向 <code>index.html</code>，详细用法见 webpack官网。</p><h2 id="eslint" tabindex="-1"><a class="header-anchor" href="#eslint"><span>ESLint</span></a></h2><pre><code class="language-bash"><span class="token comment"># 安装</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span> 
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><p><code>eslint-loader</code> 还有许多配置参数可以设置：</p><pre><code class="language-js"><span class="token comment">// webpack.config.js</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span> 
  <span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">rules</span><span class="token operator">:</span> <span class="token punctuation">[</span>
      <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><pre><code class="language-js"><span class="token comment">// .eslintrc.js</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><blockquote><p>VSCode 安装 ESLint 插件，实时显示错误。</p></blockquote>`,242),k=s("code",null,"Eslint parsing error: Unexpected token <",-1),i={href:"https://github.com/BenoitZugmeyer/eslint-plugin-html",target:"_blank",rel:"noopener noreferrer"},d=a(`<div class="custom-container tip"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"></circle><path d="M12 8h.01"></path><path d="M11 12h1v4h1"></path></g></svg><p class="custom-container-title">TIP</p><p>实际项目中为了不影响打包速度，可以不配置 <code>eslint-loader</code>，而是直接通过 git 钩子，在提交命令代码时进行检测，当然这个时候就放弃了实时报错的特性。</p><pre><code class="language-bash"><span class="token function">git</span> 钩子 eslint src
</code></pre></div><h2 id="提升打包速度" tabindex="-1"><a class="header-anchor" href="#提升打包速度"><span>提升打包速度</span></a></h2><ol><li>跟上技术的迭代，保持最新（Node/Npm/Yarn）</li><li>在尽快少的模块上使用 <code>loader</code>，比如通过 <code>include</code> 和 <code>exclude</code> 来指定打包监听范围<pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  <span class="token literal-property property">module</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">rules</span><span class="token operator">:</span> <span class="token punctuation">[</span>
      <span class="token punctuation">{</span>
        <span class="token literal-property property">test</span><span class="token operator">:</span> <span class="token regex"><span class="token regex-delimiter">/</span><span class="token regex-source language-regex">\\.js$</span><span class="token regex-delimiter">/</span></span><span class="token punctuation">,</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></li><li>尽量精简 <code>plugin</code>，并且确保其可靠性</li><li>合理配置 extensions<pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>  
<span class="token punctuation">}</span>
</code></pre></li></ol><h2 id="loader-原理" tabindex="-1"><a class="header-anchor" href="#loader-原理"><span>Loader 原理</span></a></h2><h3 id="小案例" tabindex="-1"><a class="header-anchor" href="#小案例"><span>小案例</span></a></h3><p>创建一个可以将 字符串 <code>reco</code> 替换为 <code>luan</code> 的简单 <code>loader</code></p><pre><code class="language-js"><span class="token comment">// 新建一个loader /loaders/replaceLoader.js</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="获取参数" tabindex="-1"><a class="header-anchor" href="#获取参数"><span>获取参数</span></a></h3><pre><code class="language-js"><span class="token keyword">const</span> loaderUtils <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;loader-utils&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="丰富反馈内容" tabindex="-1"><a class="header-anchor" href="#丰富反馈内容"><span>丰富反馈内容</span></a></h3><p>借助 <code>this.callback</code>：</p><pre><code class="language-js"><span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">callback</span><span class="token punctuation">(</span>
...
<span class="token punctuation">)</span>
</code></pre><pre><code class="language-js"><span class="token keyword">const</span> loaderUtils <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;loader-utils&#39;</span><span class="token punctuation">)</span>
...
<span class="token punctuation">}</span>
</code></pre><h3 id="resolveloader" tabindex="-1"><a class="header-anchor" href="#resolveloader"><span>resolveLoader</span></a></h3><p>作用是寻找 loader 时可以直接去我们自定义的文件夹内去寻找。</p><pre><code class="language-js"><span class="token comment">// 使用</span>
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="异步处理" tabindex="-1"><a class="header-anchor" href="#异步处理"><span>异步处理</span></a></h3><pre><code class="language-js"><span class="token keyword">const</span> loaderUtils <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;loader-utils&#39;</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span><span class="token function-variable function">exports</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">source</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">this</span><span class="token punctuation">.</span><span class="token function">callback</span><span class="token punctuation">(</span><span class="token keyword">null</span><span class="token punctuation">,</span> result<span class="token punctuation">,</span> sourceMap<span class="token punctuation">,</span> meta<span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><blockquote><p>loader 还可以做哪些工作呢？比如 给代码添加 try catch，本地化，替换中英文</p></blockquote><h2 id="plugin-原理" tabindex="-1"><a class="header-anchor" href="#plugin-原理"><span>Plugin 原理</span></a></h2><h3 id="简单-plugin" tabindex="-1"><a class="header-anchor" href="#简单-plugin"><span>简单 Plugin</span></a></h3><pre><code class="language-js"><span class="token comment">// /plugins/copyright-webpack-plugin.js</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><h3 id="node-调试" tabindex="-1"><a class="header-anchor" href="#node-调试"><span>Node 调试</span></a></h3><pre><code class="language-json"><span class="token comment">// package.json</span>
<span class="token punctuation">{</span>
  <span class="token property">&quot;script&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><ul><li><code>--inspect</code> 开启 Node 调试</li><li><code>--inspect-brk</code> 在代码第一行添加一个 debug 命令</li></ul><pre><code class="language-js"><span class="token keyword">class</span> <span class="token class-name">CopyrightWebpackPlugin</span> <span class="token punctuation">{</span>
  <span class="token function">apply</span> <span class="token punctuation">(</span><span class="token parameter">compiler</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    compiler<span class="token punctuation">.</span>hooks<span class="token punctuation">.</span>compile<span class="token punctuation">.</span><span class="token function">tap</span><span class="token punctuation">(</span><span class="token string">&#39;CopyrightWebpackPlugin&#39;</span><span class="token punctuation">,</span> <span class="token punctuation">(</span><span class="token parameter">compilation</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> CopyrightWebpackPlugin
</code></pre><p>打开控制台的 Node 图标，就进入了 Node 调试</p><h2 id="bundler-源码编写" tabindex="-1"><a class="header-anchor" href="#bundler-源码编写"><span>Bundler 源码编写</span></a></h2><h3 id="入口文件分析" tabindex="-1"><a class="header-anchor" href="#入口文件分析"><span>入口文件分析</span></a></h3><pre><code class="language-js"><span class="token keyword">const</span> fs <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;fs&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
...
</code></pre><h3 id="依赖图谱" tabindex="-1"><a class="header-anchor" href="#依赖图谱"><span>依赖图谱</span></a></h3><pre><code class="language-js"><span class="token keyword">const</span> fs <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;fs&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> babel <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;@babel/core&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> parser <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;@babel/parser&#39;</span><span class="token punctuation">)</span> <span class="token comment">// 分析抽象语法树</span>
<span class="token keyword">const</span> traverse <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;@babel/traverse&#39;</span><span class="token punctuation">)</span><span class="token punctuation">.</span>default
...
</code></pre><h3 id="生成可用代码" tabindex="-1"><a class="header-anchor" href="#生成可用代码"><span>生成可用代码</span></a></h3><pre><code class="language-js"><span class="token keyword">const</span> fs <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;fs&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> path <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> babel <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;@babel/core&#39;</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> parser <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;@babel/parser&#39;</span><span class="token punctuation">)</span> <span class="token comment">// 分析抽象语法树</span>
<span class="token keyword">const</span> traverse <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;@babel/traverse&#39;</span><span class="token punctuation">)</span><span class="token punctuation">.</span>default
...
</code></pre><h2 id="深入学习" tabindex="-1"><a class="header-anchor" href="#深入学习"><span>深入学习</span></a></h2><h3 id="createreactapp" tabindex="-1"><a class="header-anchor" href="#createreactapp"><span>CreateReactApp</span></a></h3><h3 id="vue-cli" tabindex="-1"><a class="header-anchor" href="#vue-cli"><span>vue-cli</span></a></h3><h3 id="vue" tabindex="-1"><a class="header-anchor" href="#vue"><span>Vue</span></a></h3><h2 id="其他" tabindex="-1"><a class="header-anchor" href="#其他"><span>其他</span></a></h2><h3 id="清除性能报错" tabindex="-1"><a class="header-anchor" href="#清除性能报错"><span>清除性能报错</span></a></h3><pre><code class="language-js">module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><h3 id="启动一个服务" tabindex="-1"><a class="header-anchor" href="#启动一个服务"><span>启动一个服务</span></a></h3><pre><code class="language-bash"><span class="token function">npm</span> <span class="token function">install</span> http-server <span class="token parameter variable">-D</span>
</code></pre><p>将 dist 目录 作为根目录启动服务：</p><pre><code class="language-json"><span class="token punctuation">{</span>
  <span class="token property">&quot;scripts&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">&quot;start&quot;</span><span class="token operator">:</span> <span class="token string">&quot;http-server dist&quot;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre>`,47);function g(y,m){const p=o("ExternalLinkIcon");return e(),c("div",null,[u,s("p",null,[n("如果报错 "),k,n("，可以借助 "),s("a",i,[n("eslint-plugin-html"),l(p)]),n("来解决。")]),d])}const b=t(r,[["render",g],["__file","072401.html.vue"]]),f=JSON.parse('{"path":"/blogs/frontEnd/2019/072401.html","title":"webpack 基础知识整理","lang":"zh-CN","frontmatter":{"title":"webpack 基础知识整理","date":"2019-07-24T00:00:00.000Z","tags":["webpack"],"categories":["frontEnd"]},"headers":[{"level":2,"title":"webpack简介","slug":"webpack简介","link":"#webpack简介","children":[]},{"level":2,"title":"安装","slug":"安装","link":"#安装","children":[]},{"level":2,"title":"运行","slug":"运行","link":"#运行","children":[]},{"level":2,"title":"loader","slug":"loader","link":"#loader","children":[{"level":3,"title":"file-loader","slug":"file-loader","link":"#file-loader","children":[]},{"level":3,"title":"url-loader","slug":"url-loader","link":"#url-loader","children":[]},{"level":3,"title":"css相关","slug":"css相关","link":"#css相关","children":[]}]},{"level":2,"title":"plugin","slug":"plugin","link":"#plugin","children":[{"level":3,"title":"html-webpack-plugin","slug":"html-webpack-plugin","link":"#html-webpack-plugin","children":[]},{"level":3,"title":"clean-webpack-plugin","slug":"clean-webpack-plugin","link":"#clean-webpack-plugin","children":[]}]},{"level":2,"title":"多个输出文件","slug":"多个输出文件","link":"#多个输出文件","children":[]},{"level":2,"title":"sourceMap","slug":"sourcemap","link":"#sourcemap","children":[]},{"level":2,"title":"监听变动","slug":"监听变动","link":"#监听变动","children":[{"level":3,"title":"webpack --watch","slug":"webpack-watch","link":"#webpack-watch","children":[]},{"level":3,"title":"webpack-dev-server","slug":"webpack-dev-server","link":"#webpack-dev-server","children":[]}]},{"level":2,"title":"Babel","slug":"babel","link":"#babel","children":[{"level":3,"title":"安装","slug":"安装-1","link":"#安装-1","children":[]},{"level":3,"title":"语法转换","slug":"语法转换","link":"#语法转换","children":[]},{"level":3,"title":"变量、对象转换","slug":"变量、对象转换","link":"#变量、对象转换","children":[]},{"level":3,"title":"组件库的封装","slug":"组件库的封装","link":"#组件库的封装","children":[]},{"level":3,"title":".babelrc","slug":"babelrc","link":"#babelrc","children":[]}]},{"level":2,"title":"React打包","slug":"react打包","link":"#react打包","children":[]},{"level":2,"title":"Tree Shaking","slug":"tree-shaking","link":"#tree-shaking","children":[{"level":3,"title":"development","slug":"development","link":"#development","children":[]},{"level":3,"title":"production","slug":"production","link":"#production","children":[]}]},{"level":2,"title":"配置文件整理","slug":"配置文件整理","link":"#配置文件整理","children":[]},{"level":2,"title":"Code Splitting","slug":"code-splitting","link":"#code-splitting","children":[{"level":3,"title":"原理","slug":"原理","link":"#原理","children":[]},{"level":3,"title":"webpack实现","slug":"webpack实现","link":"#webpack实现","children":[]},{"level":3,"title":"SplitChunksPlugin","slug":"splitchunksplugin","link":"#splitchunksplugin","children":[]}]},{"level":2,"title":"Lazy Loading & Chunk","slug":"lazy-loading-chunk","link":"#lazy-loading-chunk","children":[{"level":3,"title":"Lazy Loading","slug":"lazy-loading","link":"#lazy-loading","children":[]},{"level":3,"title":"Chunk","slug":"chunk","link":"#chunk","children":[]}]},{"level":2,"title":"打包分析","slug":"打包分析","link":"#打包分析","children":[{"level":3,"title":"Prefetching","slug":"prefetching","link":"#prefetching","children":[]},{"level":3,"title":"Preloading","slug":"preloading","link":"#preloading","children":[]},{"level":3,"title":"总结","slug":"总结","link":"#总结","children":[]}]},{"level":2,"title":"CSS代码分割","slug":"css代码分割","link":"#css代码分割","children":[{"level":3,"title":"CSS分割","slug":"css分割","link":"#css分割","children":[]},{"level":3,"title":"CSS 压缩","slug":"css-压缩","link":"#css-压缩","children":[]},{"level":3,"title":"合并 CSS","slug":"合并-css","link":"#合并-css","children":[]}]},{"level":2,"title":"浏览器缓存","slug":"浏览器缓存","link":"#浏览器缓存","children":[]},{"level":2,"title":"Shimming (垫片)","slug":"shimming-垫片","link":"#shimming-垫片","children":[]},{"level":2,"title":"环境变量","slug":"环境变量","link":"#环境变量","children":[]},{"level":2,"title":"区分模式打包","slug":"区分模式打包","link":"#区分模式打包","children":[]},{"level":2,"title":"函数库打包","slug":"函数库打包","link":"#函数库打包","children":[{"level":3,"title":"指定代码运行范围","slug":"指定代码运行范围","link":"#指定代码运行范围","children":[]},{"level":3,"title":"略过不需要的依赖","slug":"略过不需要的依赖","link":"#略过不需要的依赖","children":[]}]},{"level":2,"title":"Progressive Web Application","slug":"progressive-web-application","link":"#progressive-web-application","children":[]},{"level":2,"title":"TypeScript 的打包配置","slug":"typescript-的打包配置","link":"#typescript-的打包配置","children":[]},{"level":2,"title":"WebpackDevServer 请求转发","slug":"webpackdevserver-请求转发","link":"#webpackdevserver-请求转发","children":[{"level":3,"title":"proxy","slug":"proxy","link":"#proxy","children":[]},{"level":3,"title":"historyApiFallback","slug":"historyapifallback","link":"#historyapifallback","children":[]}]},{"level":2,"title":"ESLint","slug":"eslint","link":"#eslint","children":[]},{"level":2,"title":"提升打包速度","slug":"提升打包速度","link":"#提升打包速度","children":[]},{"level":2,"title":"Loader 原理","slug":"loader-原理","link":"#loader-原理","children":[{"level":3,"title":"小案例","slug":"小案例","link":"#小案例","children":[]},{"level":3,"title":"获取参数","slug":"获取参数","link":"#获取参数","children":[]},{"level":3,"title":"丰富反馈内容","slug":"丰富反馈内容","link":"#丰富反馈内容","children":[]},{"level":3,"title":"resolveLoader","slug":"resolveloader","link":"#resolveloader","children":[]},{"level":3,"title":"异步处理","slug":"异步处理","link":"#异步处理","children":[]}]},{"level":2,"title":"Plugin 原理","slug":"plugin-原理","link":"#plugin-原理","children":[{"level":3,"title":"简单 Plugin","slug":"简单-plugin","link":"#简单-plugin","children":[]},{"level":3,"title":"Node 调试","slug":"node-调试","link":"#node-调试","children":[]}]},{"level":2,"title":"Bundler 源码编写","slug":"bundler-源码编写","link":"#bundler-源码编写","children":[{"level":3,"title":"入口文件分析","slug":"入口文件分析","link":"#入口文件分析","children":[]},{"level":3,"title":"依赖图谱","slug":"依赖图谱","link":"#依赖图谱","children":[]},{"level":3,"title":"生成可用代码","slug":"生成可用代码","link":"#生成可用代码","children":[]}]},{"level":2,"title":"深入学习","slug":"深入学习","link":"#深入学习","children":[{"level":3,"title":"CreateReactApp","slug":"createreactapp","link":"#createreactapp","children":[]},{"level":3,"title":"vue-cli","slug":"vue-cli","link":"#vue-cli","children":[]},{"level":3,"title":"Vue","slug":"vue","link":"#vue","children":[]}]},{"level":2,"title":"其他","slug":"其他","link":"#其他","children":[{"level":3,"title":"清除性能报错","slug":"清除性能报错","link":"#清除性能报错","children":[]},{"level":3,"title":"启动一个服务","slug":"启动一个服务","link":"#启动一个服务","children":[]}]}],"git":{"createdTime":1716921053000,"updatedTime":1716921053000,"contributors":[{"name":"Reco","email":"recoluan@qq.com","commits":1}]},"filePathRelative":"blogs/frontEnd/2019/072401.md"}');export{b as comp,f as data};
